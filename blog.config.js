...
const BLOG = {
  ...
  GREETING_WORDS:
    ...
    'Hi，我是一个数模爱好者, Hi，我是一个金融量化民工,Hi，我是一个Reg Monkey,欢迎来到我的博客🎉',

  CUSTOM_MENU: process.env.NEXT_PUBLIC_CUSTOM_MENU || false, // 支持Menu 类型，从3.12.0版本起，各主题将逐步支持灵活的二级菜单配置，替代了原来的Page类型，此配置是试验功能、默认关闭。

  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || 'Gordon', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || 'Reg Monkey & Quant & 数模爱好者', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://blog.csdn.net/EasyMCM?spm=1010.2135.3001.5343', // 网站地址
